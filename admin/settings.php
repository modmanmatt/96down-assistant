...
function dbfw_render_form() { ?>
	...
	<div class="wrap">
		...
		<div class="author postbox">
			...
			<div class="inside">
				<div class="top">
					<img class="author-image" src="http://calicotek.com/wp-content/uploads/2014/04/calicotek-logo.jpg" height="150px" width="150px" />
					<p>
						<?php printf( __( 'Hi, my name is ModManMatt, I hope you like this plugin! Please check out any of my other plugins on <a href="%s" title="CaliCoTek">CaliCoTek.com</a>. You can find out more information about me via the following links:', 'dashboard-feed-widget' ),
							esc_url( 'http://calicotek.com' )
									); ?> <br /><hr /> <a href="http://96down.com/private/"><img src="../wp-content/plugins/96down-assistant/images/96down-icon5.png" width="50%" height="50%" target="_blank" title="Visit 96Down"/></a>
					</p>
				</div> <!-- end .top -->
